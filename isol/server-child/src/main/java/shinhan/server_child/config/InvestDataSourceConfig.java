...
@EnableJpaRepositories(
        basePackages = {
                "shinhan.server_child.domain.invest.repository",
                "shinhan.server_common.domain.invest.investRepository"},
...
public class InvestDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean investEntityManagerFactory(
        ...
        em.setPackagesToScan("shinhan.server_common.domain.invest.investEntity");
