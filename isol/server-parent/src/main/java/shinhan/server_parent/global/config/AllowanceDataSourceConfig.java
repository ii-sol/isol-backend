package shinhan.server_parent.global.config;
...
@EnableJpaRepositories(
        basePackages = "shinhan.server_parent.domain.allowance.repository",
...
public class AllowanceDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean allowanceEntityManagerFactory(
        ...
        em.setPackagesToScan(
                "shinhan.server_parent.domain.allowance.entity");
