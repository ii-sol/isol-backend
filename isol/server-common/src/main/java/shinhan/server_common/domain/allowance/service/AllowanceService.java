package shinhan.server_common.domain.allowance.service;
...
public class AllowanceService {
    ...
    //용돈 조르기 수락/거절
    public void handleAllowanceAcception(Long userSerialNumber, Integer temporalAllowanceId ,Boolean accept) {
        // 해당되는 용돈 조르기 가져옴
